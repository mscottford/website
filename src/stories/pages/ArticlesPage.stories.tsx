...
export const SingleArticleDark: Story = {
  ...SingleArticle,
  ...atViewport('desktop', { theme: 'dark' }),
}

export const SingleArticleDarkMobile: Story = {
  ...SingleArticle,
  ...atViewport('mobile', { theme: 'dark' }),
}

export const SingleArticleDarkTablet: Story = {
  ...SingleArticle,
...
export const EmptyDarkMobile: Story = {
  ...Empty,
  ...atViewport('mobile', { theme: 'dark' }),
}

export const EmptyDarkTablet: Story = {
  ...Empty,
  ...atViewport('tablet', { theme: 'dark' }),
}
