...
import { type Post, allSocialLinks } from 'content-collections'
...
function Article({ article }: { article: HomePageArticle }) {
  return (
    <Card as="article">
...
/** The articles the home page needs; a real `Post` satisfies it. */
...
/**
 * The home page, minus the data it renders.
 *
 * `src/app/page.tsx` is an async server component, which Storybook cannot
 * render directly, and it reads its article list from content collections,
 * which would make snapshots change every time a post is published. Keeping the
 * markup here, driven by props, means the stories render this component rather
 * than a copy of it that can drift out of step.
 */
